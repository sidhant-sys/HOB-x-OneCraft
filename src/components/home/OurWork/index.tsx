            ...
            (card, index) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col h-auto md:h-[188px] relative overflow-hidden items-center">
                  ...
                  <div className="text-[18px] md:text-[24px] leading-[24px] md:leading-[30.09px] font-[400] text-secondary500 text-center mb-[10px] md:mb-[20px] transition-transform duration-500 transform group-hover:translate-y-[-100px] font-['Marcellus']">
                    {card.title}
                  </div>
